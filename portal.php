...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Jetset with Joy: Your Epic Travel Odyssey Awaits!</div>
		<div class="masthead-heading text-uppercase"> Unveil the World's Hidden Gems!</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">Explore Now</a>
	</div>
</header>
<!-- Services-->
